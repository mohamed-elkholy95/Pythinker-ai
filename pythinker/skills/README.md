...
This directory contains built-in skills that extend pythinker's capabilities.
...
When skills reference large local documentation or logs, prefer pythinker's built-in
