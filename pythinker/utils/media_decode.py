...
Historically lived in ``pythinker.api.server``; now shared by the WebSocket
...
class FileSizeExceeded(Exception):  # noqa: N818  -- public exception name shipped in 0.1.x; rename would break callers
